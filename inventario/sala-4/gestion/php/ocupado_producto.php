...
mysql_query("UPDATE sala4 SET 
          razon_social='ocupado',
          nombre='ocupado',
          tipo_equipo='ocupado',
           marca='ocupado',
          n_serie='ocupado',
          observaciones='ocupado',
           posicion='ocupado',
          modelo='ocupado' WHERE id_rack = '$id'");

//ACTUALIZAMOS LOS REGISTROS Y LOS OBTENEMOS

 $registro3 = mysql_query("SELECT * FROM sala4 where id_rack  = $id ");
...
$rack =  $registro1['rack'] ;
 ...
 $registro = mysql_query("SELECT * FROM sala4 where rack  = $rack");
