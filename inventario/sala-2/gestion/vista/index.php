...
<body>
    ...
    >
               ...
               <!-- /.tabla de registro -->
                       <ol class="breadcrumb">
                            ...
                            <li class="">
                              <a href="../">   <i class="fa fa-dashboard"></i> Gestion Sala 2 Rack <?php    $id=$_REQUEST['id']; echo "$id";?> </a> </li>
                            </li>
                            <li class="active">
                               <i class="fa fa-dashboard"></i> Gestion Sala 2  Rack<?php    $id=$_REQUEST['id']; echo "$id";?>  Unidades</li>
                            </li>
                        </ol>
               <!-- Page Heading -->
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                       DataCenter San Martin     Gestion Sala 2  Rack  <?php    $id=$_REQUEST['id']; echo "$id";?>
                        </h1>
 ...
 <?php
            ...
            $registro = mysql_query("SELECT * FROM sala2 where rack = $id "); 
